...
# Streamlit App UI
st.title("SOC Analyst Assistant – Incident RAG Investigation System")

st.write("""
    Welcome to the SOC ANALYST ASSISTANT- Incident RAG Investigation System. 
    Please enter your user ID and ask your question below.
""")
